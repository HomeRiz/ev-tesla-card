...
`;const _TM={m3:{l:"Model 3",years:[{y:"2017\u20132022",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"W38B",l:'18" Aero'}]}]},my:{l:"Model Y",years:[{y:"2020\u20132023",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"WY19B",l:'19" Gemini'},{v:"WY20P",l:'20" Induction'}]}]},ms:{l:"Model S",years:[{y:"2021+",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PMNG",l:"Midnight Silver"},{v:"PN00",l:"Quicksilver"},{v:"PR01",l:"Ultra Red"}],wheels:[{v:"WS90",l:'19" Tempest'},{v:"WS10",l:'21" Arachnid'}]},{y:"2012\u20132020",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"WTAS",l:'19" Slipstream'},{v:"WTSG",l:'21" Turbine'}]}]},mx:{l:"Model X",years:[{y:"2021+",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PMNG",l:"Midnight Silver"},{v:"PN00",l:"Quicksilver"},{v:"PR01",l:"Ultra Red"}],wheels:[{v:"WX00",l:'20" Cyberstream'},{v:"WX20",l:'22" Turbine'}]},{y:"2015\u20132020",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"WT20",l:'20" Slipstream'},{v:"WT22",l:'22" Turbine'}]}]},ct:{l:"Cybertruck",years:[{y:"2023+",colors:[{v:"PMBL",l:"Stealth Black"},{v:"PPSW",l:"Ultra White"},{v:"PMNG",l:"Silver"}],wheels:[{v:"WCT20",l:'20" Standard'},{v:"WCT22",l:'22" Sport'}]}]}};class pt extends ct{static properties={_config:{state:!0},_hass:{state:!0},_tsModel:{state:!0},_tsYear:{state:!0},_tsColor:{state:!0},_tsWheel:{state:!0}};static styles=n`
  ...
  `;constructor(){super(),this._config={},this._tsModel="",this._tsYear="",this._tsColor="",this._tsWheel=""}set hass(t){this._hass=t}setConfig(t){this._config={...t}}_fire(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config}},bubbles:!0,composed:!0}))}_set(t,e){if(""===e||null==e){const e={...this._config};delete e[t],this._config=e}else this._config={...this._config,[t]:e};this._fire()}_buildTeslaUrl(){const m=this._tsModel,c=this._tsColor,w=this._tsWheel;if(!m||!c)return null;const parts=[`$${c}`,w?`$${w}`:null].filter(Boolean);return`https://static-assets.tesla.com/v1/compositor/?model=${m}&view=STUD_3QTR&size=1440&options=${parts.join(",")}&bkba_opt=1`}_entitySelector(t,e,i){const dom=Array.isArray(i)&&i.length===1?i[0]:i;const s=dom?{entity:{domain:dom}}:{entity:{}};return V`
      <ha-selector
        .hass=${this._hass}
        .selector=${s}
        .label=${e}
    ...
    `:V``}}customElements.define("ev-tesla-card",class extends ct{static styles=dt;static properties={_hass:{state:!0},_config:{state:!0}};_cachedImageUrl=null;setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}set hass(t){this._hass=t}shouldUpdate(t){if(t.has("_config"))return!0;if(!t.has("_hass"))return!1;const e=["battery_entity","charging_entity","location_entity","range_entity","charge_limit_entity","odometer_entity","charging_power_entity","time_remaining_entity","image_entity"],i=t.get("_hass");return e.some(k=>this._config?.[k]&&i?.states[this._config[k]]!==this._hass?.states[this._config[k]])}getCardSize(){return 4}_handleTap(ev){ev.stopPropagation();const a=this._config?.tap_action||{action:"more-info"};if("none"===a.action)return;if("navigate"===a.action&&a.navigation_path){history.pushState(null,"",a.navigation_path);this.dispatchEvent(new CustomEvent("location-changed",{bubbles:!1}));return}if("call-service"===a.action&&a.service){const[d,s]=a.service.split(".");this._hass?.callService(d,s,a.service_data||{},a.target||{});return}if("url"===a.action&&a.url_path){window.open(a.url_path,"_blank");return}const eid=a.entity_id||this._config?.battery_entity;if(eid)this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:eid}}))}_state(t){return this._hass&&t?this._hass.states[t]??null:null}get _batteryLevel(){const t=this._state(this._config?.battery_entity);if(!t)return null;const e=parseFloat(t.state);return isNaN(e)?null:e}get _isCharging(){const t=this._state(this._config?.charging_entity);return t?["on","charging"].includes(t.state?.toLowerCase()):null}get _chargingPower(){const t=this._state(this._config?.charging_power_entity);if(!t)return null;const e=parseFloat(t.state);if(isNaN(e)||0===e)return null;return{value:Number.isInteger(e)?e:Math.round(10*e)/10,unit:t.attributes?.unit_of_measurement??"kW"}}get _chargeLimit(){const t=this._state(this._config?.charge_limit_entity);if(!t)return null;const e=parseFloat(t.state);return isNaN(e)?null:e}get _isHome(){const t=this._state(this._config?.location_entity);return t?"home"===t.state?.toLowerCase():null}get _range(){const t=this._state(this._config?.range_entity);if(!t)return null;const e=parseFloat(t.state);return isNaN(e)?null:{value:Math.round(e),unit:t.attributes?.unit_of_measurement||""}}get _odometer(){const t=this._state(this._config?.odometer_entity);if(!t)return null;const e=parseFloat(t.state);return isNaN(e)?null:{value:Math.round(e).toLocaleString(),unit:t.attributes?.unit_of_measurement||""}}get _timeRemaining(){const t=this._state(this._config?.time_remaining_entity);if(!t)return null;const e=parseFloat(t.state);if(isNaN(e)||e<=0)return null;const i=(t.attributes?.unit_of_measurement??"").toLowerCase();let s=e;if("h"===i||"hours"===i)s=60*e;const r=Math.floor(s/60),n=Math.round(s%60);return r>0&&n>0?`${r}h ${n}m`:r>0?`${r}h`:`${n}m`}get _imageUrl(){const t=this._config;let u=null;if(t?.image_url)u=t.image_url;else{const e=this._state(t?.image_entity);if(e?.attributes?.entity_picture){const p=e.attributes.entity_picture;u=p.startsWith("/")&&this._hass?.hassUrl?`${this._hass.hassUrl}${p}`:p}}if(u!=null){const nb=u.split("?")[0],ob=(this._cachedImageUrl||"").split("?")[0];if(nb!==ob)this._cachedImageUrl=u}return this._cachedImageUrl||null}render(){const t=(this._config||{}).title??"Tesla",e=this._batteryLevel,i=!0===this._isCharging,s=this._chargingPower,r=this._timeRemaining,n=this._chargeLimit,a=this._isHome,o=this._range,l=this._odometer,c=this._imageUrl,h=null===e?"":e>=35?"tier-high":e>=10?"tier-mid":"tier-low",d=[];return o&&d.push({icon:"mdi:road-variant",label:"Range",value:o.value,unit:o.unit}),i&&null!==n&&d.push({icon:"mdi:battery-charging-high",label:"Charge limit",value:n,unit:"%"}),!i&&l&&d.push({icon:"mdi:counter",label:"Odometer",value:l.value,unit:l.unit}),V`
      <ha-card class="${i?"is-charging":""}" @click=${this._handleTap.bind(this)}>
